...
public class MapConfig implements IMapConfig {
        ...
        public final Transform GoalPoint = new Transform(new Point(11.143, -6.7607, 4.9654),
                        new Quaternion(0, 0, -0.707f, 0.707f));
        public final Transform Point1 = new Transform(new Point(11.2746, -9.92284, 5.2988),
                        new Quaternion(0, 0, -0.707f, 0.707f));
        public final Transform Point2 = new Transform(new Point(10.612, -9.0709, 4.48),
                        new Quaternion(0.5f, 0.5f, -0.5f, 0.5f));
        public final Transform Point3 = new Transform(new Point(10.71, -7.7, 4.48),
        ...
        public final Transform Point5 = new Transform(new Point(11.114, -7.9756, 5.3393),
                        new Quaternion(-0.5f, -0.5f, -0.5f, 0.5f));
        public final Transform Point6 = new Transform(new Point(11.355, -8.9929, 4.7818), new Quaternion(0, 0, 0, 1));

        public final Transform Point7 = new Transform(new Point(11.369, -8.5518, 4.48),
                        new Quaternion(0, 0.707f, 0, 0.707f));
